...
# Hack for initializing the database using traversalgroup
# as a script. Considered using sqlalchemy's schema definition
# language, although the only benefit I see in that is for the
# schema to be DBMS-independent, which I don't care about right
# now--SQLite3 will do just fine. Mainly using sqlalchemy for
